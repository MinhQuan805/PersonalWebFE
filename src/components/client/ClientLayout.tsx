        ...
        <Layout className="layout-main">
          <Header className="header-main" data-aos="fade-down" data-aos-delay="50">
            ...
            <div className="contact-header">
              <a href={personal.about.socials.linkedin} target="_blank" rel="noopener noreferrer">
                <img src="/image/logo/linkedin.png" alt="LinkedIn" />
              </a>
              <a href={personal.about.socials.github} target="_blank" rel="noopener noreferrer">
            ...
            <div className="footer-container">
              <div className="footer-left">
                ...
                <div className="footer-contact-text">
                  <p>Copyright &copy; {new Date().getFullYear()} {personal.intro.name}</p>
                  <p>Powered by React & Ant Design</p>
                </div>
              </div>
              ...
              <div className="footer-right">
                ...
                <div className="footer-column-right">
                  <Link href={`/article/read/${personal.about.link}`}>About the Author</Link>
                  <a
                    href="https://docs.google.com/document/d/1RmD96OAt-Dn-pqEpEM5YUUhfyvZ3HxQfqTGAXuTDsKA/edit?tab=t.0"
                    target="_blank"
